...
export class ScrollService {
  ...
  public sectionScreenCoverage$: BehaviorSubject<SectionScreenCoverage>
    = new BehaviorSubject(this.sectionScreenCoverage);

  public sectionScrollOffsetPercentage$: BehaviorSubject<SectionScrollOffsetPercentageModel>
    = new BehaviorSubject<SectionScrollOffsetPercentageModel>(this.sectionScrollOffsetPercentage);
