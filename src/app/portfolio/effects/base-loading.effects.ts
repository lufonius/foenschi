...
import { SetLoadAction, SetLoadFailureAction, SetLoadSuccessAction } from '../../core/actions/base-loading.actions';
import {
...
import { LoadProjectsAction, ProjectActionTypes, ProjectsLoadFailureAction, ProjectsLoadSuccessAction } from '../actions/project.actions';
import { SkillsPageActionTypes } from '../actions/skills.actions';
